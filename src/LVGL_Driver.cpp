...
void example_increase_lvgl_tick(void *arg)
{
    ...
    // lv_tick_inc is not needed when LV_TICK_CUSTOM is enabled in lv_conf.h
...
void Lvgl_Init(void)
{
  ...
  disp_drv.hor_res = LVGL_WIDTH;   // 172 (portrait width)
  disp_drv.ver_res = LVGL_HEIGHT;  // 320 (portrait height)
